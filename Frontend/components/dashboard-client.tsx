  ...
  return (
    <div>
          ...
          <div className="mb-6 lg:mb-8">
            <div>
              <h2 className="text-2xl lg:text-3xl font-bold mb-2 text-balance">Welcome back, {user.fname} {user.lname}!</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-8">
          ...
          <Card className="border-purple-100 hover:shadow-lg transition-all duration-200 hover:border-purple-200">
            ...
            <CardContent>
              <div className="text-lg font-bold text-balance text-purple-600 mb-1">{user.phone}</div>
              <p className="text-xs text-muted-foreground flex items-center gap-1">
